...
export type GeminiChatModelMeta = {
  ...
  label: string;
  /** Etiqueta no dropdown/trigger — descrições longas só na ajuda (?). */
...
export const GEMINI_CHAT_MODELS: GeminiChatModelMeta[] = [
  {
    ...
    dropdownLabel: 'Gemini 2.5 Flash',
